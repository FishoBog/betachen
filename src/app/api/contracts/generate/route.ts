...
<div class="footer">
  ይህ ሰነድ በቤታችን ሪል እስቴት ፕላትፎርም (Betachen-et.netlify.app) ተዘጋጅቷል | Generated by ቤታችን Real Estate Platform<br/>
...
<div class="footer">Generated by ቤታችን | Document ID: ${contract.id} | ${today}</div>
</body></html>`;
  }
