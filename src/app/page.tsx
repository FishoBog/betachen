...
export default function HomePage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#ffffff' }}>
      ...
      {/* Hero */}
      <div style={{ background: 'linear-gradient(135deg, #006AFF 0%, #0047CC 60%, #003DA5 100%)', padding: '72px 24px 80px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', maxWidth: 720, margin: '0 auto' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'rgba(232,67,26,0.25)', border: '1px solid rgba(232,67,26,0.5)', borderRadius: 20, padding: '6px 16px', marginBottom: 24 }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: 18, marginBottom: 40, lineHeight: 1.6 }}>
          ...
          <div style={{ background: 'white', borderRadius: 16, padding: 8, display: 'flex', gap: 8, maxWidth: 600, margin: '0 auto', boxShadow: '0 20px 60px rgba(0,0,0,0.3)' }}>
            ...
            <button style={{ padding: '12px 28px', background: '#E8431A', color: 'white', border: 'none', borderRadius: 10, fontWeight: 700, fontSize: 15, cursor: 'pointer' }}>
              Search
            </button>
          </div>
      ...
      <div style={{ background: '#006AFF', padding: '64px 24px', textAlign: 'center' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: 16, marginBottom: 32 }}>Join thousands of owners on ጎጆ</p>
