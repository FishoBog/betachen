...
import { Mail, Home, MapPin, ListChecks, Upload, CheckCircle, CreditCard, ArrowRight, ShieldCheck, Clock, Phone } from 'lucide-react';
...
export default function HowToPostPage() {
  ...
  const steps = [
    ...
    },
    {
      ...
      color: '#1d4ed8',
      bg: '#dbeafe',
      titleEN: 'Step 1 — Property details',
      titleAM: 'ደረጃ 1 — የንብረት ዝርዝር',
      bodyEN: 'Write a clear title (e.g. "3 Bedroom Apartment in Bole"). Choose For Sale, Rent or Short Stay. Set the price — or mark it negotiable. Pick Residential or Commercial, then fill in bedrooms, bathrooms, size and any extra rooms. Add construction stage and title deed type if you know them.',
      bodyAM: 'ግልጽ ርዕስ ይጻፉ (ለምሳሌ "3 መኝታ ክፍል አፓርትመንት ቦሌ")። ሽያጭ፣ ኪራይ ወይም የአጭር ጊዜ ይምረጡ። ዋጋ ያስገቡ — ወይም ለድርድር ክፍት ያድርጉት። የመኖሪያ ወይም የንግድ ይምረጡ፣ ከዚያ መኝታ ክፍሎች፣ መታጠቢያዎች፣ ስፋት እና ተጨማሪ ክፍሎችን ይሙሉ።',
    },
    {
      icon: MapPin,
      color: '#065f46',
      bg: '#d1fae5',
      titleEN: 'Step 2 — Location',
      titleAM: 'ደረጃ 2 — አካባቢ',
      ...
      bodyAM: 'ከተማዎንና ክፍለ ከተማዎን ይምረጡ፣ ከዚያ ወረዳ፣ ቀበሌ እና አቅራቢያ ያለ ምልክት ይጨምሩ። ለካርታ ምልክት: ጉግል ካርታ ይክፈቱ፣ ንብረትዎን ያግኙ፣ መጋጠሚያዎቹን ቅዳ እና ይለጥፉ። ይህ አማራጭ ነው ግን ለገዢዎች በጣም ይረዳል።',
    },
    {
      icon: ListChecks,
      color: '#7c3aed',
      bg: '#ede9fe',
      titleEN: 'Step 3 — Features & details',
      titleAM: 'ደረጃ 3 — ባህሪያትና ዝርዝሮች',
      ...
      bodyAM: 'የቦታ ስፋት፣ ማቆሚያ፣ የውሃና የኤሌክትሪክ አስተማማኝነት፣ ኢንተርኔት፣ ደህንነት (ቅጥር ግቢ፣ ጠባቂ)፣ አቅራቢያ ምልክቶችና እንደ ዋይፋይ፣ ጀነሬተር ወይም አሳንሰር ያሉ መገልገያዎችን ይጨምሩ።',
    },
    {
      icon: Upload,
      color: '#92400e',
      bg: '#fef3c7',
      titleEN: 'Step 4 — Photos',
      titleAM: 'ደረጃ 4 — ፎቶዎች',
      ...
      bodyAM: 'ግልጽ ፎቶዎችን ይስቀሉ — እስከ 10 ድረስ። የመጀመሪያው ፎቶ ሽፋን ይሆናል፣ ስለዚህ ምርጡን ያድርጉት። ብሩህ፣ ሰፊ የእያንዳንዱ ክፍል ፎቶዎች ይሻላሉ። ጥሩ ፎቶ ያላቸው ማስታወቂያዎች ብዙ መልዕክት ያገኛሉ።',
    },
    {
      icon: CheckCircle,
      color: '#059669',
      bg: '#d1fae5',
      titleEN: 'Step 5 — Review & publish',
      titleAM: 'ደረጃ 5 — ይገምግሙ እና ያትሙ',
