...
export default function DiasporaPage() {
  return (
    <div style={{ minHeight: '100vh', background: '#ffffff' }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, #0a0f14 0%, #1a2a3a 50%, #0f3460 100%)', padding: '80px 24px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', maxWidth: 820, margin: '0 auto' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: '#E8431A', borderRadius: 20, padding: '8px 20px', marginBottom: 24 }}>
            <span style={{ color: 'white', fontSize: 14, fontWeight: 700, letterSpacing: '1px' }}>🌍 DIASPORA INVESTMENT HUB</span>
          </div>
          <h1 style={{ fontSize: 'clamp(34px, 5vw, 56px)', fontWeight: 900, color: 'white', lineHeight: 1.1, marginBottom: 20 }}>
            Invest in Ethiopia<br /><span style={{ color: '#FF6B35' }}>From Anywhere in the World</span>
          </h1>
          <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: 19, lineHeight: 1.7, marginBottom: 40, maxWidth: 640, margin: '0 auto 40px' }}>
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' as const }}>
            <Link href="/" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '15px 30px', background: '#E8431A', color: 'white', borderRadius: 12, fontWeight: 700, fontSize: 16, textDecoration: 'none' }}>
              Browse Properties <ArrowRight size={18} />
            </Link>
            <a href="https://t.me/BetachenBot" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '15px 30px', background: 'rgba(255,255,255,0.1)', color: 'white', borderRadius: 12, fontWeight: 700, fontSize: 16, textDecoration: 'none', border: '1px solid rgba(255,255,255,0.2)' }}>
              ✈️ Talk to an Agent
            </a>
          </div>
        </div>
      ...
      <div style={{ maxWidth: 1600, margin: '0 auto', padding: '80px 24px' }}>
        <div style={{ textAlign: 'center', marginBottom: 56 }}>
          <h2 style={{ fontSize: 40, fontWeight: 900, color: '#111827', marginBottom: 14 }}>Why Diaspora Investors Choose ቤታችን</h2>
          <p style={{ color: '#6b7280', fontSize: 18, maxWidth: 620, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: 28 }}>
          {[
            ...
            <div key={title} style={{ background: 'white', borderRadius: 20, border: '1px solid #e5e7eb', padding: '32px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
              ...
              <div style={{ display: 'inline-block', background: bg, color, fontSize: 12, fontWeight: 700, padding: '4px 12px', borderRadius: 20, marginBottom: 12, letterSpacing: '0.3px' }}>{tag}</div>
      ...
      {/* How it works */}
      <div style={{ background: '#f9fafb', padding: '80px 24px', borderTop: '1px solid #e5e7eb', borderBottom: '1px solid #e5e7eb' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            <h2 style={{ fontSize: 36, fontWeight: 900, color: '#111827', marginBottom: 14 }}>How It Works</h2>
            <p style={{ color: '#6b7280', fontSize: 17 }}>From browsing to owning — here's how diaspora investment works on ቤታችን</p>
          </div>
          <div style={{ display: 'grid', gap: 20 }}>
            {[
              ...
              <div key={step} style={{ display: 'flex', gap: 22, background: 'white', borderRadius: 16, padding: '28px', border: '1px solid #e5e7eb' }}>
                <div style={{ width: 52, height: 52, borderRadius: 12, background: '#E8431A', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: 16, fontWeight: 900, flexShrink: 0 }}>{step}</div>
                <div>
      ...
      <div style={{ maxWidth: 1600, margin: '0 auto', padding: '80px 24px' }}>
        <div style={{ background: 'linear-gradient(135deg, #0a0f14, #1a2a3a)', borderRadius: 24, padding: '52px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 44, alignItems: 'center' }}>
          <div>
            <div style={{ fontSize: 14, fontWeight: 700, color: '#E8431A', marginBottom: 12, textTransform: 'uppercase' as const, letterSpacing: '1px' }}>🔒 Privacy First</div>
            <h2 style={{ fontSize: 32, fontWeight: 900, color: 'white', marginBottom: 16, lineHeight: 1.2 }}>Exact locations shared only in private</h2>
          ...
          <div style={{ display: 'grid', gap: 16 }}>
            <div style={{ background: 'rgba(255,255,255,0.06)', borderRadius: 14, padding: '22px', border: '1px solid rgba(255,255,255,0.1)' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <div>
                  <div style={{ fontSize: 16, fontWeight: 700, color: 'white' }}>Bole, Addis Ababa</div>
                  <div style={{ fontSize: 13, color: '#6b7280' }}>Approximate area • ~500m radius</div>
                </div>
              </div>
            </div>
            <div style={{ background: 'rgba(255,255,255,0.06)', borderRadius: 14, padding: '22px', border: '1px solid rgba(255,255,255,0.1)' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <span style={{ fontSize: 22 }}>🔒</span>
                <div>
                  <div style={{ fontSize: 16, fontWeight: 700, color: 'white' }}>Exact address + GPS</div>
                  <div style={{ fontSize: 13, color: '#6b7280' }}>Shared in direct message only</div>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* CTA */}
      <div style={{ background: '#006AFF', padding: '72px 24px', textAlign: 'center' }}>
        <h2 style={{ fontSize: 36, fontWeight: 800, color: 'white', marginBottom: 12 }}>Ready to invest in Ethiopia?</h2>
        <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: 17, marginBottom: 32, maxWidth: 540, margin: '0 auto 32px' }}>
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' as const }}>
          ...
          <a href="https://t.me/BetachenBot" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '15px 30px', background: 'white', color: '#006AFF', borderRadius: 12, fontWeight: 700, fontSize: 16, textDecoration: 'none' }}>
